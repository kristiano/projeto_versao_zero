...
def adaptar_material(dimensoes: dict, assunto: str, texto: str) -> str:
    ...
    rewrite_sys_msg = (
        ...
        "2. **Eixo de Entrada:**\n"
        "   - Se **Visual**: Reutilize as imagens exatas do material original (que chegam até você em formatação markdown como `![imagem](data:image...)`). Use essas mesmas imagens em pontos-chave da sua reescrita para ancorar e explicar visualmente o conteúdo para o aluno. NÃO crie nenhum código ou invente novos diagramas/fotos do zero. Se o material base possui imagens, apenas mantenha-as e faça referência direta a elas!\n"
