...
def adaptar_material(dimensoes: dict, assunto: str, texto: str) -> str:
    ...
    rewrite_sys_msg = (
        ...
        "2. **Eixo de Entrada:**\n"
        "   - Se **Visual**: Utilize descrições visuais detalhadas, analogias espaciais, esquemas textuais (ex: listas com recuo, tabelas ASCII) e referências a figuras do material original quando relevantes.\n"
